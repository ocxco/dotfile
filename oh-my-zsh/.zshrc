...
export PATH=$PATH:$GO_HOME/bin:$ECLIPSE_HOME:$ADB_HOME
...
#    fi
#fi
export EDM=$HOME/workspace/www/edm
export CRM=$HOME/workspace/www/crm
export PROMOMAN=$HOME/workspace/www/promoman
export SERVICES=$HOME/workspace/www/services
export EDITOR=vim
alias  edm=$EDM
alias  crm=$CRM
alias  pro=$PROMOMAN
